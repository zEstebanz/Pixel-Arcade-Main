        ...
        <Container>
            ...
            <div className={estilos.indexCoverBack}>
                ...
                {usuario ? (
                    ...
                    <>
                        <div className={`${estilos.titleCustom}`}>
                            <h1> No estas registrado crack</h1>
                            <Link href="/signin" className='nes-btn'> Crear Cuenta</Link>
                            <h1>Y si tenes una cuenta inicia sesion capo</h1>
                            <Link href="/login" className='nes-btn'> Iniciar Sesion</Link>
                        </div>
